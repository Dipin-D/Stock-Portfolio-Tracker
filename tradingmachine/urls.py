...
urlpatterns = [
    ...
    path('api/glidepaths/save/', views.save_glidepath, name='save_glidepath'),
    path('api/glidepaths/<int:glidepath_id>/', views.get_saved_glidepath, name='get_saved_glidepath'),
